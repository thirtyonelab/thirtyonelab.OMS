...
export default function Reports() {
  ...
  const reportData = useMemo(() => {
    const safeInvoices = (Array.isArray(invoices) ? invoices : []).filter(inv => {
      ...
      const hasPayment = statusUpper === 'PAID' || statusUpper === 'DEPOSIT' || parseFloat(inv.deposit || 0) > 0;
    ...
    // Delivery / Courier Profit from Invoices for selected month (only confirmed invoices)
              ...
              <div className="thank-you-footer print-avoid-break" style={{ marginTop: 'auto', paddingTop: '1.5rem', borderTop: '1px solid #e6e2dc' }}>
                <div style={{ fontSize: '0.7rem', color: '#555', marginBottom: '1rem', textAlign: 'left' }}>
                  ...
                  <p style={{ margin: '0.1rem 0 0 0', lineHeight: '1.3' }}>
                    Penyata kewangan ini dijana secara automatik berdasarkan pesanan yang sah (invois dengan deposit atau bayaran penuh). Invois draf/belum bayar tanpa deposit tidak dimasukkan bagi mengelakkan herotan hasil jualan sebenar.
                  </p>
                </div>
